...
public class UserValidator extends Exception {
    ...
    public void valid(boolean result,String msg) throws InvalidExceptions {
        if (result) {
            ...
            throw new InvalidExceptions(msg);
        }
    }

    public boolean checkFirstName(String FirstName,String sms) throws InvalidExceptions {
    ...
    public boolean checkLastName(String LastName,String sms) throws InvalidExceptions {
    	IUser iuser = ((input, regex) -> input.matches(regex));
    ...
    public boolean validMobileNumber(String Phone,String sms) throws InvalidExceptions {
        IUser iuser = ((input, regex) -> input.matches(regex));
    ...
    public boolean validPassword(String Password,String sms) throws InvalidExceptions {
    	IUser iuser = ((input, regex) -> input.matches(regex));
